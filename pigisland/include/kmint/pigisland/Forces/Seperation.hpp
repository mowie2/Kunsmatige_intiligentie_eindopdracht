...
class Seperation : public Force
{
public:
	Seperation(kmint::play::free_roaming_actor& actorIn, kmint::math::vector2d forceIn, float factorIn) : Force(actorIn, forceIn, factorIn) {}
