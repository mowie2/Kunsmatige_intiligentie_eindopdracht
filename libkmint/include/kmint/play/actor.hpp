...
* \return true if the actor must be drawn in the next frame. False otherwise.
  ...
  /*! \brief Gets an iterator at pierOne_-past-the-end of the collision set
   */
  interaction_iterator end_collision() {
    return util::wrap_iterator<actor>(collision_set_.end(), deref_actor);
  }

  /*! \brief Gets a  const iterator at pierOne_-past-the-end of the collision set
   */
  ...
  /*! \brief Gets a iterator at pierOne_-past-the-end of the collision set
   */
...
/*!
 * Determine if pierTwo_ actors have collided
 ...
 * \return true if the collision radii of the pierTwo_ actors overlap
 */
